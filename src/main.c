...
FIXED:BUGFIX: WHEN I CREATE A FOLDER THEN CREATE ANOTHER ONE THE NUMBER SEEMS TO START AT THE NUMBER OF THAT FOLDER, NOT A NUMBER UP.
BUGFIX: WHEN CREATING A FOLDER IN A DIR WITH ONE FOLDER E.G [99] ARCHIVE THEY ARE OUT OF ORDER (MAYBE EDGECASE FOR ONE OTHER DIR CAN BE IMPLEMENTED MANUALLY)
ALSO SHOULD CHECK FOR OTHER CHECKS
BUGFIX: WHEN CREATING N DIRECTORIES, IT ALTERNATES BETWEEN:
CREATE, DONT CREATE, CREATE, DONT CREATE
...
int main(int argc, char *argv[])
{
    ...
    {
        // view = NAVIAGE;
        strcpy(current_path, "/home/abigreenberg/Documents/[01] Tech/[01] Programming/[02] c/file_manager/[02] one");
        view = EDIT;
        highlight = 4;
