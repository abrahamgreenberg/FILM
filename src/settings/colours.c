...
void init_colours()
{
    ...
    init_pair(DEFAULT_RED_INDEX, DEFAULT_RED_INDEX + 9, DEFAULT_BACKGROUND_INDEX + 9);
    init_pair(DEFAULT_BLUE_INDEX, DEFAULT_BLUE_INDEX + 9, DEFAULT_BACKGROUND_INDEX + 9);
    init_pair(DEFAULT_CYAN_INDEX, DEFAULT_CYAN_INDEX + 9, DEFAULT_BACKGROUND_INDEX + 9);
    init_pair(DEFAULT_YELLOW_INDEX, DEFAULT_YELLOW_INDEX + 9, DEFAULT_BACKGROUND_INDEX + 9);
    init_pair(DEFAULT_MAGENTA_INDEX, DEFAULT_MAGENTA_INDEX + 9, DEFAULT_BACKGROUND_INDEX + 9);

    init_pair(DRACULA_BACKGROUND_INDEX, DRACULA_TEXT_INDEX + 9, DRACULA_BACKGROUND_INDEX + 9);
    init_pair(DRACULA_RED_INDEX, DRACULA_RED_INDEX + 9, DRACULA_BACKGROUND_INDEX + 9);
    init_pair(DRACULA_BLUE_INDEX, DRACULA_BLUE_INDEX + 9, DRACULA_BACKGROUND_INDEX + 9);
    init_pair(DRACULA_CYAN_INDEX, DRACULA_CYAN_INDEX + 9, DRACULA_BACKGROUND_INDEX + 9);
    init_pair(DRACULA_YELLOW_INDEX, DRACULA_YELLOW_INDEX + 9, DRACULA_BACKGROUND_INDEX + 9);
    init_pair(DRACULA_MAGENTA_INDEX, DRACULA_MAGENTA_INDEX + 9, DRACULA_BACKGROUND_INDEX + 9);

    init_pair(AYU_MIRAGE_BACKGROUND_INDEX, AYU_MIRAGE_TEXT_INDEX + 9, AYU_MIRAGE_BACKGROUND_INDEX + 9);
    init_pair(AYU_MIRAGE_RED_INDEX, AYU_MIRAGE_RED_INDEX + 9, AYU_MIRAGE_BACKGROUND_INDEX + 9);
    init_pair(AYU_MIRAGE_BLUE_INDEX, AYU_MIRAGE_BLUE_INDEX + 9, AYU_MIRAGE_BACKGROUND_INDEX + 9);
    init_pair(AYU_MIRAGE_CYAN_INDEX, AYU_MIRAGE_CYAN_INDEX + 9, AYU_MIRAGE_BACKGROUND_INDEX + 9);
    init_pair(AYU_MIRAGE_YELLOW_INDEX, AYU_MIRAGE_YELLOW_INDEX + 9, AYU_MIRAGE_BACKGROUND_INDEX + 9);
    init_pair(AYU_MIRAGE_MAGENTA_INDEX, AYU_MIRAGE_MAGENTA_INDEX + 9, AYU_MIRAGE_BACKGROUND_INDEX + 9);
}
